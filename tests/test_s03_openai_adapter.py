...
MODULE_PATH = ROOT / "s03_permission" / "code.py"
...
def load_s03_module():
    ...
    spec = importlib.util.spec_from_file_location("s03_under_test", MODULE_PATH)
...
def test_s03_uses_openai_function_tool_schema():
    module = load_s03_module()
...
def test_s03_denied_permission_appends_openai_tool_result(monkeypatch):
    module = load_s03_module()
    calls = []
    ...
    monkeypatch.setattr(module, "ask_user", lambda tool_name, args, reason: "deny")
